...
import { Menu, Dropdown, Button, Col } from 'antd';
...
const HeaderModules = ({ modules, org, darkMode, activeModule, setActiveModule, ability }) => {
    ...
    return (
        <Col span={8} ref={ref2} style={{ margin: "20px", display: 'flex', alignItems: 'center', flexWrap: 'nowrap' }}>
            <Link
            ...
            {extraModules.length > 0 && (
                <Dropdown overlay={extraModulesMenu} trigger={['hover']}>
